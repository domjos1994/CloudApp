...
class MDExportBuilder(private val context: Context) : BaseExportBuilder(context) {
    override suspend fun exportNotifications(): String {
        ...
        var content = printHeader(1, "Notifications")
        content += createTable(
            listOf(
                "id",
                "app",
    ...
    override suspend fun exportData(): String {
        ...
        var content = printHeader(1, "Data")
        content += createTable(
            listOf(
                "path",
                "name",
    ...
    override suspend fun exportNotes(): String {
        ...
        var content = printHeader(1, "Notes")
        content += createTable(
            listOf(
                "id",
                "title",
    ...
    private fun printHeader(type: Int, value: String): String {
        var line = ""
        for(i in type downTo 1 step 1) {
            line = "#$line"
        }
        return "$line $value\n"
    }
